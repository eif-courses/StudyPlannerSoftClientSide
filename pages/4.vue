...
<!--              {{ timeSlot }} <Badge :value="(index + 1)" size="small" severity="secondary"></Badge>-->
<!--            </th>-->
            ...
            >
              ...
              <div class="time-slot text-gray-600">
                {{ timeSlot }}
              </div>
            </th>
...
.lecture-title {
  font-weight: bold;
  font-size: 0.9em; /* Slightly larger than the time slot */
}
.time-slot {
  font-size: 0.75em; /* Smaller for less prominence */
  color: #b8bfc7; /* Light gray */
}
